...
from lib.process_datamanipulation import volume_spike_indicator
...
def main():
    ...
    obj_logger      = set_logging(fp       = configInfo.fp["fp_log_file"],
                                  fn       = configInfo.fn["fn_log_indicatorvolumespike"],
    ...
    df_processing = df_processing.run_multiprocessing(int_parts = 2,
                                                      str_funcname = volume_spike_indicator,
